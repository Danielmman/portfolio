	...
	>
		...
		>
			<h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
				Hi! I'm <span class="poppins text-violet-400">Daniel</span>
				Imman
				<br />Full Stack
		...
		<div class="relative shadow-2xl grid place-items-center">
			<img
				src={"https://media.licdn.com/dms/image/D5603AQFOtqfPwwV_mg/profile-displayphoto-shrink_800_800/0/1693842168278?e=1718236800&v=beta&t=2zjoMLel5Q7kE0thEaz7lClvBavj7Qk2Auykf0pNUMk"}
				alt="Zetane Engine"
			...
			{#each benefits as benefit, index}
				<div class="flex flex-col gap-2 mx-auto">
					<div class="flex items-end gap-4">
						...
						<p class="text-xl sm:text-2xl md:text-3xl capitalize pb-2">
							{benefit.name}
						</p>
					</div>
