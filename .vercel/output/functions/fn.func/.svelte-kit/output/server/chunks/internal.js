...
const options = {
  ...
  templates: {
	...
	<div class="absolute min-h-screen top-0 left-0 w-full z-[-1]">
		<div class="absolute inset-0" id="particles-js"></div>
	</div>
	<script>
		particleJS.load('particles-js', 'asserts/particlesjs.json', function() {
			console.log("Conflics particle js for backend animation");
		});
	<\/script>
</body>
